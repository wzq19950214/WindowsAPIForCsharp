...
namespace GTR
{
    public class KeyMouse : KmHelper
    {
        ...
        {
            KmSendExtentKey(WinApi.VK_F12, true);
            Sleep(20);
            KmSendExtentKey(WinApi.VK_F12, false);
            Sleep(20);
        }
        ...
        public static void SendKeyW(char ch,int times)
        {
        ...
        public static void SendKG()
        {
            KmSendExtentKey(WinApi.VK_kg, true);
            Sleep(20);
            KmSendExtentKey(WinApi.VK_kg, false);
            Sleep(20);
        }
    ...
    public class WinApi
    {
        ...
        public static UInt32 VK_kg = 0x20;
        public static UInt32 VK_KeyW = 0x87;
        public static UInt32 VK_KeyA = 0x65;
        public static UInt32 VK_KeyS = 0x83;
        public static UInt32 VK_KeyD = 0x68;
